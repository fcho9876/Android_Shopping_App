...
public class XiaomiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Window window = XiaomiActivity.this.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.setStatusBarColor(ContextCompat.getColor(XiaomiActivity.this, R.color.xiaomiOrange));
        ...
        phoneInfo = DataProvider.generateXiaomiData();
    ...
    private void setOnClickListener() {
        listener = new PhoneInfoAdapter.RecycleViewClickerListener() {
            ...
            public void onClickPhone(View v, int position) {
                //Sending information to DetailsActivity
