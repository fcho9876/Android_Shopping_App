...
public class AppleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Window window = AppleActivity.this.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.setStatusBarColor(ContextCompat.getColor(AppleActivity.this, R.color.appleGrey));
        ...
        phoneInfo = DataProvider.generateAppleData();

        //Sets onclick listener to know when Recycle view has been clicked
        setOnClickListener();
    ...
    private void setOnClickListener(){
        listener = new PhoneInfoAdapter.RecycleViewClickerListener() {
            ...
            public void onClickPhone(View v, int position) {
                //Grabbing the information to send to details activity
